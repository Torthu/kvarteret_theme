 ...
 *
 * Contains the closing of the id=body div and all content
 ...
 */
?>
		<div id="opening_hours" class="cf">
				<div class="left three_cols cf">
					<span class="big opening_title">
						Grøndahl (pub 1. etg)
					</span>
					<ul class="opening_hours">
						<li>Man-ons 20:00 - 01:00</li>
						<li>Tor-lør 19:00 - 03:00</li>
						<li>Søn åpen ved fotball</li>
					</ul>
				</div>
				<div class="left three_cols cf">
					<span class="big opening_title">
						Stjernesalen (kafé 2. etg)
					</span>
					<ul class="opening_hours">
